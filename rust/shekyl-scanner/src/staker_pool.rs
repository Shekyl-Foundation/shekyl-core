...
//!
//! See [`shekyl_wallet_state::staker_pool`] for the canonical implementation.
//! This shim exists only to keep `crate::staker_pool::…` import paths working
//! during the migration; it is removed in Commit 2n.

pub use shekyl_wallet_state::staker_pool::{AccrualRecord, ConservationCheck, StakerPoolState};
