...
//! 3. [`PayloadError`] — SWSP (Shekyl Engine State Payload) framing errors:
...
pub enum WalletFileError {
    ...
    /// [`PrefsError`](shekyl_engine_prefs::PrefsError) verbatim so
    ...
    /// signalled via [`shekyl_engine_prefs::LoadOutcome::Tampered`]
