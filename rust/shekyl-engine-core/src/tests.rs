...
mod lifecycle {
    ...
    fn plan_specific_rejects_non_staked() {
        ...
        assert!(matches!(result, Err(EngineCoreError::NotStaked { .. })));
    }
    ...
    fn claim_and_unstake_rejects_locked() {
        ...
        assert!(matches!(result, Err(EngineCoreError::NotMatured { .. })));
    }
    ...
    fn claim_and_unstake_rejects_spent() {
        ...
        assert!(matches!(result, Err(EngineCoreError::AlreadySpent { .. })));
    }
