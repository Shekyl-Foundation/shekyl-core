...
impl core::fmt::Debug for PartialSpendAuthAndLinkability {
    fn fmt(&self, fmt: &mut core::fmt::Formatter<'_>) -> Result<(), core::fmt::Error> {
        fmt.debug_struct("PartialSpendAuthAndLinkability")
    ...
    Algorithm<Ed25519T> for SalAlgorithm<R, T>
{
    ...
    fn sign_share(
        ...
        let alpha = Zeroizing::new(<Ed25519 as Ciphersuite>::F::random(
            &mut deterministic_nonces,
        ));
        let beta = Zeroizing::new(<Ed25519 as Ciphersuite>::F::random(
            &mut deterministic_nonces,
        ));
        let delta = Zeroizing::new(<Ed25519 as Ciphersuite>::F::random(
            &mut deterministic_nonces,
        ));
        let mu = Zeroizing::new(<Ed25519 as Ciphersuite>::F::random(
            &mut deterministic_nonces,
        ));
        let r_z = Zeroizing::new(<Ed25519 as Ciphersuite>::F::random(
            &mut deterministic_nonces,
        ));
        let r_p = Zeroizing::new(<Ed25519 as Ciphersuite>::F::random(
            &mut deterministic_nonces,
        ));
        let r_r_p = Zeroizing::new(<Ed25519 as Ciphersuite>::F::random(
            &mut deterministic_nonces,
        ));
