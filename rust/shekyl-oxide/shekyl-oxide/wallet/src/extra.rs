...
impl Extra {
  ...
  /// first introduced by `shekyl-wallet` (under the shekyl-oxide project) and may be bespoke to
  /// the ecosystem of shekyl-oxide and dependents of it.
  ///
  ...
  /// methods of stegnography are supported outright by `shekyl-wallet`.
