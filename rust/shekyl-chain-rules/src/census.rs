...
census_rows! {
    ...
    pub enum CenRow: Consensus {
        ...
        // rows landed in `tx_form` at slice 6 commit 2 (`rules/tx.rs`,
        // "census 4.I, the stateless rows"); the view-bound and
        // verification rows follow in `tx_against`.
        I1 implemented(crate::rules::tx::I1),
        I2 pending,
        I3 pending,
        I4 implemented(crate::rules::tx::I4),
        I5 implemented(crate::rules::tx::I5),
        I6 implemented(crate::rules::tx::I6),
        I7 pending,
        I8 implemented(crate::rules::tx::I8),
        I9 implemented(crate::rules::tx::I9),
        I10 pending,
        I11 pending,
        I12 pending,
        I13 pending,
        I14 implemented(crate::rules::tx::I14),
        I15 pending,
        I16 implemented(crate::rules::tx::I16),
        I17 pending,
        I18 pending,
        I19 pending,
        I20 pending,
