...
The script uses only the Python standard library (`hmac`, `hashlib`,
`json`, `os`, `struct`, `sys`, `pathlib`) — no third-party dependencies
to install. Outputs `../../docs/test_vectors/PQC_OUTPUT_SECRETS.json`
