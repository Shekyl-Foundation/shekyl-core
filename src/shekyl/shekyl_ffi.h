...
//! hold a bucket header (the epee shim returns a null slice, the historical
//! contract); -7 above the Levin packet limit.
...
//! shekyl_buffer_free); -3 when noise_size cannot hold two headers; -7
//! above the Levin packet limit.
