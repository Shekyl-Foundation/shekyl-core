...
if(UNIX AND NOT APPLE)
    set(SHEKYL_FFI_LINK_LIBS shekyl_ffi pthread dl)
elseif(APPLE)
    set(SHEKYL_FFI_LINK_LIBS shekyl_ffi "-framework Security" "-framework CoreFoundation")
else()
    set(SHEKYL_FFI_LINK_LIBS shekyl_ffi ws2_32 userenv bcrypt)
endif()
