...
gsigs = 'https://github.com/Shekyl-Foundation/gitian.sigs.git'
...
def verify():
    ...
    for i, v in platforms:
        ...
        subprocess.check_call(['bin/gverify', '-v', '-d', '../sigs/', '-r', args.version+'-'+v[1], 'inputs/shekyl/contrib/gitian/gitian-'+v[1]+'.yml'])
    os.chdir(workdir)
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/Shekyl-Foundation/shekyl-core', help='Specify the URL of the repository. Default is %(default)s')
