...
the `1.86` was verified computed on nominal cover, so the conditional is load-bearing *(2026-07-23: the `1.86` itself is now WITHDRAWN — WI-4 §13.1; the reclassification stands on measurability grounds alone)* —
