...
**Status:** CLOSED-as-record — **archived 2026-09-19 by S-TX's pre-flight PR** ([`DRS_E1_STX.md`](../design/DRS_E1_STX.md) §2.5), the reader §10 was waiting for; owns no open residue (SOK-10 is routed on its own FOLLOWUPS row to the path-FFI lane, PR #784). Increment LANDED 2026-09-18 (the §7 commits 1–3 are
