...
| Parent plan | [`docs/design/RANDOMX_V2_PLAN.md`](../design/RANDOMX_V2_PLAN.md) — Track A Phase 2 status note (2026-05-25; line 304); parent plan-doc's `todos:` list does not yet carry a `phase2h-*` entry — this plan-doc's closure adds one |
...
- **Parent [`RANDOMX_V2_PLAN.md`](../design/RANDOMX_V2_PLAN.md) §6 ≤5.0×
