...
**Status:** CLOSED-as-record (2026-09-16). Items 1–3 are landed and live in CI; MR-DQ-2 and MR-DQ-6 were RULED 2026-08-19; nothing remains owned here. Do not implement from this document — `.github/workflows/randomx-v2-differential.yml` is the code of record.
...
**RECORDS-WAS — Deliberately left open for implementation-time measurement:** C1's
...
### 7.3 The one genuinely open trade — RECORDS-WAS (closed with items 2–3 landing)
...
so it registers in
[`CRYPTO_DOMAIN_REGISTRY.tsv`](../design/CRYPTO_DOMAIN_REGISTRY.tsv) (SA-3b, 207
