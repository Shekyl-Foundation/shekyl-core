...
`emission_curve_asymptote_atomic` (`u64`; renamed at FL-R12′) so the bench consumes an observable
...
Pi 4). Authoritative close-out: [`FA-6_CLOSEOUT.md`](completed/FA-6_CLOSEOUT.md).
