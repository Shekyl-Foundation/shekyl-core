...
- **`docs/V3_STAKER_ARCHIVAL.md` and `docs/V3_SHARD_VISUALIZATION.md`
  ...
  domain-primitive library crate. The companion `git rm` of the
  V4-named drafts from `shekyl-dev/docs/` ships as a separate
  commit on `shekyl-dev` `dev` that references this commit's
  shekyl-core SHA.
