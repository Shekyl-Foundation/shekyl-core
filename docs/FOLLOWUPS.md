...
- **Levin p2p migration — LV-2 payload codec and LV-3 connection-path
  ...
  The framing half (builders, `BucketReader`) stays inert until LV-3.
  LV-2's build-vs-vendor question is **closed** (2026-08-13 pin below);
  implementation of that pin is in-scope. LV-3 remains **rejected-now
  with named reopening criteria** (rule 21):
