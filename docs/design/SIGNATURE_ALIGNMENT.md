...
SA-3d (#446), SA-4 (#450) MERGED; PR-SA-5 in flight; PR-SA-6 pending.
...
| **PR-SA-5** | Persona lifecycle: SA-R-6 guard + scan reconstruction; ruling into `ARCHIVAL_P_DERIVE_V1` module doc + operator guide (no-rotation stated as a refusal, clustering rationale named). **Feeds the CBOM persona no-backstop row.** | **in flight** (`feat/sa5-persona-lifecycle`, off dev) |
