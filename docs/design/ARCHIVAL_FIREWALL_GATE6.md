...
- **Round 4 drafted (2026-07-11, §12) — the drain-event firewall.** GF-7 (funding-in) already built +
  graded PROVISIONAL-PASS (`r = 1.86`) *(⛔ that verdict is WITHDRAWN in full 2026-07-23 — the graded
  channel was never on the chain; WI-4 §13.1 banner. GF4b-2's funding-input count is the surviving
  entry-seam channel)*; GF-4 (value-out) drafted as one event with three co-triggered
...
- **GF-7 (funding-in):** built + graded **PROVISIONAL-PASS** (`r = 1.86`, local-daemon; §6 R4 cell)
  *(⛔ WITHDRAWN in full 2026-07-23 — the graded channel was never on the chain; WI-4 §13.1
  banner. The entry seam's surviving channel is GF4b-2's funding-input count — structural,
  gated, not yet closed — and the transport residual is defended by circuit isolation with
  the principal-side default flip as its open front)* — its former residuals
  (effective-vs-nominal cover, cold-start) were graded on the withdrawn instrument.
