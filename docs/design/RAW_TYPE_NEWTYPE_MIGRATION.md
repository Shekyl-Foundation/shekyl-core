...
| economics [`burn.rs:27-29`](../../rust/shekyl-economics/src/burn.rs), [`params.rs:170`](../../rust/shekyl-economics/src/params.rs) `emission_curve_asymptote`, emission returns | reward/fee/supply | |
