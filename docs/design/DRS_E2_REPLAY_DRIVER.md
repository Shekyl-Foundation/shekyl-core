...
5. `ingest: form workers → sequencer → validate+connect actor (kameo, no-restart); Corrupt → halt, terminal — halt-then-assert-not-restarted test; Stale::Seed surfaced; injected-wrong-seed test` (RD-Q5, RD-Q11).
