...
because `SPL-Q3` is the moment it is fixed or reproduced. The increment
may now be cut from `dev` (§7). This file stays in `design/` as the E1/E5 boundary statement
