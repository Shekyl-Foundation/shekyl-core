...
spec to review against until the census's design rounds rule them. **CEN-B5** (rule-71 skip) is the sole divergent row; **CEN-L11** and **CEN-L12** were re-reviewed and promoted at PR #609's merged fix (2026-09-04); **CEN-I12** was re-reviewed and promoted at `667817d47`, the sha that merged its reconciliation (2026-09-05). **The review's two S-graded findings are closed** — CEN-M8/G4/J26 promoted at PR #602's merged fix, **CEN-D2 with CEN-D1 at PR #604's** (2026-09-03) — **but a third is open (2026-09-04):** CEN-B5's post-connect header check compares the root *after* the add against a header filled from the root *before* it, so every non-FAKECHAIN chain halts at height 60 — **S1**, masked by the rule-71 skip, fix-or-accept Rick's (census §7 #17). An S-graded divergence therefore gates DRS-0 again. Failed closed for the reason already given above: **CEN-L8**,
