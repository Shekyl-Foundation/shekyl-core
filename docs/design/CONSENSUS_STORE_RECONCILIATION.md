...
spec to review against until the census's design rounds rule them. **CEN-B5** (rule-71 skip — retired on PR #623 with its S1) was **re-reviewed at `e54e5b983` and PROMOTED 2026-09-11**, leaving **no divergent row**; **CEN-L11** and **CEN-L12** were re-reviewed and promoted at PR #609's merged fix (2026-09-04); **CEN-I12** was re-reviewed and promoted at `667817d47`, the sha that merged its reconciliation (2026-09-05). **The review's two S-graded findings are closed** — CEN-M8/G4/J26 promoted at PR #602's merged fix, **CEN-D2 with CEN-D1 at PR #604's** (2026-09-03) — **a third was found 2026-09-04 and is **fixed on PR #623 (2026-09-05, census §7 #18)** — the check now runs at admission before the add, on every nettype; re-verified at the merged sha `e54e5b983` on 2026-09-11 and promoted, which **discharges the last gate on DRS-0**:** CEN-B5's header check compared the root *after* the add against a header filled from the root *before* it, so every non-FAKECHAIN chain would have halted at height 60 — **S1**, masked by the rule-71 skip, which the same PR retired (census §7 #17, #18). Failed closed for the reason already given above: **CEN-L8**,
