...
spec to review against until the census's design rounds rule them. **CEN-B5** (rule-71 skip) is the sole divergent row; **CEN-L11** and **CEN-L12** were re-reviewed and promoted at PR #609's merged fix (2026-09-04). **The review's two S-graded findings are closed** — CEN-M8/G4/J26 promoted at PR #602's merged fix, **CEN-D2 with CEN-D1 at PR #604's** (2026-09-03) — **a third was found 2026-09-04 and is fixed on PR #TBD-B5 (2026-09-05), re-verification at the merged sha owed:** CEN-B5's header check compared the root *after* the add against a header filled from the root *before* it, so every non-FAKECHAIN chain would have halted at height 60 — **S1**, masked by the rule-71 skip; the check now runs at admission before the add, red → green observed on a TESTNET Blockchain fixture (census §7 #18). DRS-0 stays gated until that fix is re-verified at its merged sha. Failed closed for the two distinct reasons already given above: **CEN-L8**,
