...
spec to review against until the census's design rounds rule them. **CEN-B5** (rule-71 skip — retired on PR #623 with its S1, promotion owed) is the sole divergent row; **CEN-L11** and **CEN-L12** were re-reviewed and promoted at PR #609's merged fix (2026-09-04); **CEN-I12** was re-reviewed and promoted at `667817d47`, the sha that merged its reconciliation (2026-09-05). **The review's two S-graded findings are closed** — CEN-M8/G4/J26 promoted at PR #602's merged fix, **CEN-D2 with CEN-D1 at PR #604's** (2026-09-03) — **a third was found 2026-09-04 and is **fixed on PR #623 (2026-09-05, census §7 #18)** — the check now runs at admission before the add, on every nettype; re-verification at the merged sha owed, and only that re-review still gates DRS-0:** CEN-B5's header check compared the root *after* the add against a header filled from the root *before* it, so every non-FAKECHAIN chain would have halted at height 60 — **S1**, masked by the rule-71 skip, which the same PR retired (census §7 #17, #18). Failed closed for the reason already given above: **CEN-L8**,
...
| **CSR-3a** | The **conformance register** (§5.4.1): a bucket says a rule is *ratified*, never that the C++ *implements* it | every parity claim asserting correctness | **ROW COVERAGE COMPLETE OVER THE 2026-09-02 SET** — the **102** bucket-1/2 rows that existed then are disposed: **100 CHECKED-CONFORMANT / 1 DIVERGENT / 1 failed closed** over P0f's **102-row** snapshot (the live bucket-1/2 set is **121** after C2-R1b's nine and C2-R1c's ten, all nineteen UNREVIEWED pending review): CEN-B5 (rule-71 FAKECHAIN skip — retired on PR #623 with its S1, promotion owed); CEN-L8 failed closed; CEN-I12 re-reviewed and promoted at `667817d47` (2026-09-05). **The review's two S-grades are closed** — CEN-M8/G4/J26 promoted at PR #602's merged fix, CEN-D2/D1 at PR #604's — and **CEN-L11/L12 were promoted at PR #609's** (2026-09-04); **a third S-grade was found 2026-09-04 and is FIXED on PR #623 (2026-09-05): CEN-B5's header check compared the post-add root against a pre-add header — S1, every non-FAKECHAIN chain would have halted at 60; now checked at admission on every nettype, re-verification at the merged sha owed (census §7 #17, #18)**; the examined-and-excluded note on L12 covers its **staked arm only** (a retired claim-era clause), not the row. **Coverage is complete over that snapshot, and the live set has already outgrown it** — C2-R1b's nine (2026-09-03) and C2-R1c's ten (2026-09-04) promotions are UNREVIEWED, as any future bucket promotion is on arrival; **DRS-P0f** and the census own reviewing them; E2 must consult the register before calling any match correctness |
