...
rule-08 instances 12–15 (a `cargo fmt` reverting a buffer; a `git checkout`
write-back; a branch-switch write-back caught by "a file I did not edit
shows modified"; and, 2026-09-25 after commit 7c, `tx_against_tests.rs` and
