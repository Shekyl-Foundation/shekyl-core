...
| Field | Value |
|-------|-------|
| Status | Active plan document; Round 0 scaffold landed on `chore/randomx-v2-phase2h-plan` |
...
| Scaffold branch | `chore/randomx-v2-phase2h-plan` (this PR; plan-doc only; ≤5 working days per [`06-branching.mdc`](../../.cursor/rules/06-branching.mdc) rule 2) |
| Round 1+ branch | `feat/randomx-v2-phase2h-plan` (used for the Round 1+ design rounds; per Phase 2g precedent the design-phase branch is separate from the scaffold branch so each round's commit history is mechanically separable) |
| Implementation branch | `feat/randomx-v2-phase2h-impl` (implementation branch for the post-design-close work per [`26-sub-pr-design-discipline.mdc`](../../.cursor/rules/26-sub-pr-design-discipline.mdc) rounds discipline) |
