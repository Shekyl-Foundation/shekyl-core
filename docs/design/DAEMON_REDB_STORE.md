...
> **20 of 174 census rows** cite a file under `src/blockchain_db/` as an
...
is ported. Only **20 of 174 census rows** name a store file at all, and seven
of those are already bucket 3. The other **140 of 153 live consensus rows** (141/153 when this was written; CEN-F12 went to bucket 3 with E6 slice 4's precursor, 2026-09-21; CEN-I20 joined the bound set 2026-09-23) —
...
Consensus **enforced** (bucket ≠ 3) = 153 = **13 bound + 140 free** (152 / 12 / 140 between CEN-F12's deletion on 2026-09-21 and CEN-I20's minting on 2026-09-23; 153 / 141 before);
...
**Table 3 — the 140 of 153 live consensus rows that are surface-free, by census subsystem (E6's slices).**
