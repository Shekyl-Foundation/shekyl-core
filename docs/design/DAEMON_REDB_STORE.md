...
of those are already bucket 3. The other **140 of 152 live consensus rows** (141/153 when this was written; CEN-F12 went to bucket 3 with E6 slice 4's precursor, 2026-09-21) —
...
Consensus **enforced** (bucket ≠ 3) = 152 = **12 bound + 140 free** (was 153 / 141 until CEN-F12's deletion, 2026-09-21);
...
**Table 3 — the 140 of 152 live consensus rows that are surface-free, by census subsystem (E6's slices).**
