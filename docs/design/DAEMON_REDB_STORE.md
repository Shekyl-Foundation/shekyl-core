...
| Atomicity audit | **rewritten by P0b (2026-09-05)** — covers all live tables (matrix gate-pinned), all **three** prune shapes — one atomic, two checkpointed — `reset()`, `migrate()`; was: 183 lines, April 2026, **0** archival hits vs **702** in `db_lmdb.cpp` (22 of the live tables post-dated it) |
