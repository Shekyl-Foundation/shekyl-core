...
- **One read body for both transactions** (S-CHAIN-R commit 1,
  ...
  ([`DRS_E1_SCHAIN_R.md`](DRS_E1_SCHAIN_R.md) SCR-13, SCR-7). One
...
([`DRS_E1_SCHAIN_R.md`](DRS_E1_SCHAIN_R.md) §3; PR #772, 2026-09-17). Nine
...
- **Raw handles are crate-private** (Q3): `open_table` is `pub(crate)`,
  `open_multimap_table` `cfg(test)`; a later surface lands typed reads.
...
layout v5: the 49 LMDB mirrors plus two Rust-only (`undo_log`, and
