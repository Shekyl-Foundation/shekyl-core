...
| CEN-L14 | 4 | five flag-0 keyed overwrites | mechanism (`insert`/`upsert`) **E1 increment 2.5**; each site's semantics with its surface (**E4 S-ARCH** ×4, **E3 S-CURVE** ×1) once R8b-3…R8b-7 name them |
