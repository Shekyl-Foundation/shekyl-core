...
| CEN-H21 | Bond-post tx CT shape: `pqc_auths` == vin count, ≥ 1 spend (funding) input, pseudoOuts == spend count, non-empty FCMP++ proof, CT balance with (credit, debit) = (`bond_credit`, `bond_debit`); funding inputs: empty offsets, unspent KIs, FCMP++ over the spend subset (same ref-age/depth as CEN-I10–I15) | tx_verification_utils.cpp:132–148; ct_semantics.cpp:315–336; funding blockchain.cpp:3465–3485, 3670–3797 (re-pinned at `d8ebfd18c`, E6 slice 5 row 9) | C | 1 | spec | [`ARCHIVAL_BOND_GATE4.md`](ARCHIVAL_BOND_GATE4.md) | RC-119, RC-120 ⇒ merged. The funding-floor C++ copy is disclosed as pending a Rust single-source (:3772–3779) |
