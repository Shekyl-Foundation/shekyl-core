...
| Timestamp FTL | yes (Rust rule via FFI; C++ shim `:5594`) | **yes** (same rule fn via `:2363` — C2-R3-Q3 closed the was-missing bound) | re-run main |
| Timestamp median | yes (strict, newest 11) | yes (strict, newest 11 after `:2358` truncation — was the whole alt chain; C2-R3-Q1a) | re-run main |
