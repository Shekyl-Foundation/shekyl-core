...
FAKECHAIN skip, census R9), 1 failed closed (CEN-L8; CEN-I12 failed closed the
...
16. **CEN-I12's anchor source reconciled — the §7 step-2 prose was stale
    ...
    **Also corrected in the same doc:** step 1's design rationale still
    ...
    this reconciliation (done 2026-09-05 at `667817d47`, PR #TBD-I12); that re-review must walk all three read sites and
