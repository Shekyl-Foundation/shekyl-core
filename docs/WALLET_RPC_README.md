...
Phase 4b quality FOLLOWUPS still open (Engine-gated): honest `OUTGOING`
transfer history, narrowing `build_pending_tx` write-lock scope, and
richer `submit_pending_tx` verdicts.
